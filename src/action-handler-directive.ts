...
customElements.define('action-handler-flower-card', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-flower-card')) {
    return body.querySelector('action-handler-flower-card') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-flower-card');
